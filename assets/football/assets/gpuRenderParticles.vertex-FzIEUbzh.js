import{k as e,A as i,B as n,m as f,E as s,H as a,I as v}from"./index-fwjlwNUN.js";const r="gpuRenderParticlesVertexShader",o=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=o);const l=[i,n,f,s,a,v];for(const t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const c={name:r,shader:o};export{c as gpuRenderParticlesVertexShaderWGSL};
